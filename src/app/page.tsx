...
const structuredData = {
  ...
  name: "Quiz Mint AI",
  description:
    "AI-powered intelligent quiz generator supporting multiple professional certification exam preparation including AWS, Google Ads, SAP and more.",
            ...
            <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12">
              <div className="flex-1 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
                ...
                <div className="mb-6 md:mb-8">
                  ...
                  <div className="text-sm sm:text-md text-gray-600 flex flex-wrap gap-x-4 sm:gap-x-6 gap-y-1 justify-center lg:justify-start max-w-xl sm:max-w-2xl mx-auto lg:mx-0 mt-3">
                    <span>
                      <span
                        className="mr-1 sm:mr-2 text-blue-600"
                        aria-hidden="true"
                      >
                        🌐
                      </span>
                    ...
                    <span>
                      <span
                        className="mr-1 sm:mr-2 text-purple-600"
                        aria-hidden="true"
                      >
                        🤖
                      </span>
                ...
                <div className="flex justify-center lg:justify-start">
                  <Link
                    ...
                    aria-label="Get started with Quiz Mint AI intelligent quiz generator"
                  >
                    Get Started
                  </Link>
                </div>
              ...
              <div className="flex-1 relative mt-8 lg:mt-0 w-full max-w-lg mx-auto lg:max-w-none">
                <div className="relative rounded-xl overflow-hidden shadow-2xl border border-white/20">
                  <Image
                    src="/screen.png"
                    alt="Quiz Mint AI platform screenshot showing intelligent quiz generation interface"
                    width={800}
                    height={500}
